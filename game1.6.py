...
def bulletCollision(enemyList):
    for e in enemyList:
        ...
        for b in bullets:
            b_x = b.getX()
            b_y = b.getY()
            if (b_x >= e_x and b_x < (e_x + 256)) or (e_x >= b_x and e_x < (b_x + 64)):
                if (b_y >= e_y and b_y < (e_y + 256)) or (e_y >= b_y and e_y < (b_y + 64)):
                    try:
